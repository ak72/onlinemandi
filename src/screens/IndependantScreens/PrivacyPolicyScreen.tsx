  ...
  return (
    <ScrollView
      ...
      <Text
        ...
        At app4rge.com, accessible from http://www.app4rge.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        app4rge.com and how we use it.
      </Text>
      <Text
        style={{...styles.text, color: colors.text, fontSize: fontsize.body2}}>
      ...
      <Text
        ...
        and/or collect in app4rge.com. This policy is not applicable to any
      ...
      <View>
        ...
        <Text style={styles.list}>{'\u2022'} Send you emails</Text>
        <Text style={styles.list}>{'\u2022'} Find and prevent fraud</Text>
      </View>
      <Text style={{...styles.text, color: colors.text, fontSize: fontsize.h6}}>
        Log Files{' '}
      </Text>
      <Text
        style={{...styles.text, color: colors.text, fontSize: fontsize.body2}}>
        app4rge.com follows a standard procedure of using log files. These files
      ...
      <View>
        <Text style={styles.list}>
          ...
          <Text
            ...
            <Text>https://policies.google.com/technologies/ads</Text>
          </Text>
        </Text>
      </View>
      <Text style={{...styles.text, color: colors.text, fontSize: fontsize.h6}}>
      ...
      <Text>
        ...
        advertising partners of app4rge.com.
      </Text>
      <Text
        style={{...styles.text, color: colors.text, fontSize: fontsize.body2}}>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on app4rge.com, which are sent
      ...
      <Text
        style={{...styles.text, color: colors.text, fontSize: fontsize.body2}}>
        Note that app4rge.com has no access to or control over these cookies
      ...
      <Text
        style={{...styles.text, color: colors.text, fontSize: fontsize.body2}}>
        app4rge.com's Privacy Policy does not apply to other advertisers or
      ...
      <Text
        style={{...styles.text, color: colors.text, fontSize: fontsize.body2}}>
        app4rge.com does not knowingly collect any Personal Identifiable
